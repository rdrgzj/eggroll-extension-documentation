...
def get_level_choice(levels: list[str]) -> str:
    """Displays the list of available levels and asks the
...
def play_level() -> None:
    """This function displays the available levels and asks the user
    ...
    try:
        ...
        print(colored(
            f'Error: The file {choice} does not exist. Please make sure'
            'that all files are downloaded from the repoitory.',
            'red'
        ))
